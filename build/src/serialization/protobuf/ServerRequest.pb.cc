...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_ServerRequest_ServerRequest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_ServerRequest_ServerRequest_2eproto}, {
...
class ServerRequest::_Internal {
 public:
  ...
  static const ::opentxs::proto::Nym& credentials(const ServerRequest* msg);
  static void set_has_credentials(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
  static const ::opentxs::proto::Signature& signature(const ServerRequest* msg);
...
ServerRequest::_Internal::credentials(const ServerRequest* msg) {
  return *msg->credentials_;
}
const ::opentxs::proto::Signature&
ServerRequest::_Internal::signature(const ServerRequest* msg) {
...
ServerRequest::ServerRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:opentxs.proto.ServerRequest)
}
ServerRequest::ServerRequest(const ServerRequest& from)
  ...
  if (from._internal_has_credentials()) {
    credentials_ = new ::opentxs::proto::Nym(*from.credentials_);
  } else {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::opentxs::proto::ServerRequestType_IsValid(val))) {
            _internal_set_type(static_cast<::opentxs::proto::ServerRequestType>(val));
          } else {
...
::PROTOBUF_NAMESPACE_ID::uint8* ServerRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:opentxs.proto.ServerRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:opentxs.proto.ServerRequest)
  return target;
}
...
void ServerRequest::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ServerRequest*>(
      &from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:opentxs.proto.ServerRequest)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      _internal_mutable_credentials()->::opentxs::proto::Nym::MergeFrom(from._internal_credentials());
    }
    if (cached_has_bits & 0x00000010u) {
...
void ServerRequest::InternalSwap(ServerRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ServerRequest, request_)
      + sizeof(ServerRequest::request_)
      - PROTOBUF_FIELD_OFFSET(ServerRequest, credentials_)>(
...
template<> PROTOBUF_NOINLINE ::opentxs::proto::ServerRequest* Arena::CreateMaybeMessage< ::opentxs::proto::ServerRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::opentxs::proto::ServerRequest >(arena);
}
