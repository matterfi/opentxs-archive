 ...
 ************************************************************/
            ...
            UnallocatedCString{R"~!~(A few relevant notes, followed by contributor credits:


"Proclaim liberty throughout all the land
 unto all its inhabitants."
Leviticus 25:10
...
"Justice, and only justice, you shall follow,
 that you may live and inherit the land that
...
"The rulers of the Gentiles lord it over them,
 ...
 themselves 'Benefactor of the People.'"
Luke 22:25
...
"And it shall come to pass, if you listen diligently
 ...
 that the Lord your God will set you on high,
...
-----------------------------------------------------------------
 ...
 More detailed credits regarding the other contributors:
...
It seems appropriate to mention a few other people who deserve mentioning.
...
For history, I will reproduce a few gloating FBI quotes:
...
Speaking of wrongful prosecution...

Tip of the hat to Dr. Douglas Jackson for his sacrifices and
accomplishments.
May this software protect future innovators from persecution,
in a diversity of jurisdictions.

// -----------------------------------------------

Aaron Swartz, in the depths of depression, was driven to suicide by
unfair prosecution. He didn't beat, rob, or murder anyone. He was
someone who fought for the good of all mankind. His girlfriend,
Taren Stinebrickner-Kauffman, said of him:

"I've never met anyone so single-minded about changing the world."

// -----------------------------------------------

To all hackers who DDoS -- please consider building something instead.

"Strike the root."

(You won't do anyone any good in prison.)

// -----------------------------------------------

Thank you to David Chaum, for inventing digital cash in the first place.

Kudos to David Wagner, and Ben Laurie, who brought us Lucre.

Kudos to Ian Grigg for his many advancements in financial cryptography.
Check out his website at http://iang.org/

J. Orlin Grabbe and his writings have been inspirational. He will be
missed. His DMT as well as critiques of it were useful to me.
http://www.orlingrabbe.com/

Thank you to Richard Stallman: His concept of of the GPL license has
made an historic and immeasurable contribution to human liberty.

Thank you also to Satoshi Nakamoto, for developing the world's first
censorship-resistant digital asset and currency (Bitcoin.)

Kudos to Phil Zimmermann for writing and releasing PGP. The man who put
power into the hands of the people. Many people in corrupt jurisdictions
now have PGP to thank for their lives. Let's do the same for their money.

Bill St. Clair, whose Truledger was truly inspirational. Check out
Truledger at http://truledger.com/

Patrick Chkoreff, whose Loom is operational and is what showed me the
idea of separation of powers. Check out https://Loom.cc for more info.

Andrew McMeikan's PKTP, which can be found here:  http://pktp.co.cc/

Ryan Fugger's Ripple project: http://ripple-project.org/

Jim Bell, of course. His story is partially the reason for this software.
I still don't understand why he was stink-bombing IRS offices instead of
writing code. But he definitely made his mark.

Tim May for writing the Cyphernomicon. (Google it.)

Robert A. Hettinga for his writings:  http://www.philodox.com/
